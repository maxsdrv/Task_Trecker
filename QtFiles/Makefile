#############################################################################
# Makefile for building: TaskTrecker
# Generated by qmake (3.1) (Qt 5.14.1)
# Project:  TaskTrecker.pro
# Template: app
# Command: D:\Qt\5.14.1\mingw73_64\bin\qmake.exe -o Makefile TaskTrecker.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
INCPATH       = -I. -I..\..\..\..\Qt\5.14.1\mingw73_64\mkspecs\win32-g++ 
LINKER      =        g++
...
DIST          =  tasktrecker.h main.cpp \
		tasktrecker.cpp
QMAKE_TARGET  = TaskTrecker
DESTDIR        =  #avoid trailing-slash linebreak
TARGET         = TaskTrecker.exe
DESTDIR_TARGET = TaskTrecker.exe

####### Build rules

first: all
all: Makefile  TaskTrecker.exe

TaskTrecker.exe:  $(OBJECTS) 
	$(LINKER) $(LFLAGS) -o $(DESTDIR_TARGET) $(OBJECTS)  $(LIBS)

Makefile: TaskTrecker.pro ../../../../Qt/5.14.1/mingw73_64/mkspecs/win32-g++/qmake.conf ../../../../Qt/5.14.1/mingw73_64/mkspecs/features/spec_pre.prf \
		...
		TaskTrecker.pro
	$(QMAKE) -o Makefile TaskTrecker.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
...
main.o: main.cpp tasktrecker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

tasktrecker.o: tasktrecker.cpp tasktrecker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tasktrecker.o tasktrecker.cpp
